...
const kBackgoundColor = Color.fromARGB(255, 49, 0, 49);
const kbuttonColor = Color.fromARGB(255, 149, 127, 175);
const apiKey = '5f9d4bd0608c0d8b303396a95e29c3a5';
Color backgroundPrimary = Color.fromARGB(255, 255, 255, 255);
